...
name= Label(frame_body, text= "Alarm", height=1, font=('Ivy 18 bold'), bg=bg_color, fg=co2)
name.place(x=125, y=10)

hour= Label(frame_body, text= "hours", height=1, font=('Ivy 10 bold'), bg=bg_color, fg=co1)
...
min= Label(frame_body, text= "mins", height=1, font=('Ivy 10 bold'), bg=bg_color, fg=co1)
...
sec= Label(frame_body, text= "secs", height=1, font=('Ivy 10 bold'), bg=bg_color, fg=co1)
